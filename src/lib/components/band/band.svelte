...
<section class=" relative mb-20 bg-gray-200">
	<div class="relative z-10 px-2 py-24 text-center lg:px-8">
		...
		<div class="mt-8 flex justify-center space-x-4">
			<a
				href="/auth"
				class="rounded-md bg-yellow-500 px-6 py-3 text-xl font-bold text-black hover:bg-yellow-400 hover:text-black focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:ring-offset-2"
			>
				Proposer un article
			</a>
		</div>
