...
<div
	class="mx-auto my-4 flex w-full max-w-sm flex-col justify-center overflow-hidden bg-slate-900 shadow-lg sm:my-6 md:my-8 lg:my-0 lg:h-screen lg:max-w-full lg:flex-row"
>
