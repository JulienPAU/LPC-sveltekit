...
<div
	class="mx-auto my-4 flex w-full max-w-sm flex-col justify-center overflow-hidden bg-gray-900 shadow-lg sm:my-6 md:my-8 lg:my-0 lg:h-screen lg:max-w-full lg:flex-row lg:rounded-none"
>
	...
	>
		<button
			...
			class="mt-4 flex w-full transform items-center justify-center rounded-lg border text-gray-200 transition-colors duration-300 hover:bg-gray-50 dark:hover:bg-gray-600"
		>
		...
		<form method="post" on:submit|preventDefault={handleSignin} class="w-full">
			<div class="mt-4">
				<label
			...
			<div class="mt-4">
				<div class="flex flex-col justify-between sm:flex-row">
					...
					<button
						...
						class="mb-2 text-xs font-semibold text-gray-500 hover:underline sm:text-sm dark:text-gray-300"
					>
						Mot de passe oublié ?
					</button>
				</div>
			...
			<div class="mt-6">
				<button
					class="w-full transform rounded-lg bg-gray-700 px-4 py-2 text-sm font-medium capitalize tracking-wide text-white transition-colors duration-300 hover:bg-gray-600 focus:outline-none focus:ring focus:ring-gray-300 focus:ring-opacity-50 sm:px-6 sm:py-3"
				>
					Se connecter
				</button>
			</div>
